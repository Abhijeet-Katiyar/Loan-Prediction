...
dataset_train=read.delim("E:/MiniProject/All projects/Project_10/Loans_Training", sep = ",", stringsAsFactor = TRUE)
dataset_test=read.delim("E:/MiniProject/All projects/Project_10/Loans_Test", sep = ",", stringsAsFactor = TRUE)
